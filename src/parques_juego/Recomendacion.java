...
public class Recomendacion {
     ...
     *  Es recomndable en todo desarrollo ir documentando cada clase, método o 
        ...
        crear varios label que formen el tablero, asi no sea todos los pasos, pero 
        la idea de la imagen como tablero también es valida

        No son necesarios cuatro jugadores, con dos jugadores en suficiente
     * 
     * 
     * MUCHOS ÉXITOS!!!
     * 
